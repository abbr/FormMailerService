...
exports.sendMail = function(req, res) {
  ...
  function _sendMail() {
    ...
    var smtpTransport = nodemailer.createTransport(Object.getOwnPropertyNames(sysConfig.emailTransport)[0], sysConfig.emailTransport[Object.getOwnPropertyNames(sysConfig.emailTransport)[0]]);
    htmlBody += "</table>";
